...
<nav>
    ...
    <form action="" method="post">
        <input type="text" id="keyword" name="search" size="50" autofocus placeholder="Cari Data" autocomplete="off">
        <button type="submit" id="tombol-cari" name="cari">Search</button>
    </form>
    <br>
<div id="container">
